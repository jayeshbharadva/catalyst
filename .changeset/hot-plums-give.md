...
Make newsletter signup on homepage conditional based on BigCommerce settings and add e2e tests for homepage.
...
To make newsletter signup conditional based on BigCommerce settings, update your homepage code:
